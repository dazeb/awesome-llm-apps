...
| [👁️ first-reader](first-reader/) | Two simulated readers with lives meet your draft cold, one passage at a time, and leave their comments beside your text: a skim gate, a no-lookahead timed read with quit points, a recall test of what survived, a trust ledger of the implied author. Afterwards you can ask any reader a follow-up. The experience layer anti-slop skills skip; never rewrites |
